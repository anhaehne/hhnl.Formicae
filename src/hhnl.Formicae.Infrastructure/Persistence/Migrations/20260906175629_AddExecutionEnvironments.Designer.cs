...
namespace hhnl.Formicae.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260906175629_AddExecutionEnvironments")]
    partial class AddExecutionEnvironments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hhnl.Formicae.Application.Management.InviteCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("hhnl.Formicae.Application.Workflows.AiSettings", b =>
                {
                    ...
                    b.Property<string>("AcpCommand")
                        .HasColumnType("text");

                    b.Property<string>("AcpProvider")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("CodexAuthJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("Name")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("Default AI");

                    b.Property<string>("Provider")
                        .HasColumnType("text");

                    b.Property<string>("SubscriptionCredentialFileName")
                        .HasColumnType("text");

                    b.Property<string>("SubscriptionCredentialJson")
                        .HasColumnType("text");

                    b.Property<string>("SubscriptionCredentialMountPath")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("hhnl.Formicae.Application.Workflows.ExecutionEnvironmentProfile", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("execution_environments", (string)null);
                });
            ...
            modelBuilder.Entity("hhnl.Formicae.Application.Workflows.Persona", b =>
                {
                    ...
                    b.Property<string>("OperatingConstraints")
                        .IsRequired()
                        .HasMaxLength(8000)
            ...
            modelBuilder.Entity("hhnl.Formicae.Application.Workflows.Workflow", b =>
                {
                    ...
                    b.Property<string>("DslSchemaVersion")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("hhnl.Formicae.Application.Workflows.WorkflowDecisionExecution", b =>
                {
                    ...
                    b.Property<string>("ConfiguredTargetId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<Guid?>("SourceTaskRunId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("workflow_decision_executions", (string)null);
                });

            modelBuilder.Entity("hhnl.Formicae.Application.Workflows.WorkflowDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("hhnl.Formicae.Application.Workflows.WorkflowDefinitionVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IsDefault", "IsEnabled");
            ...
            modelBuilder.Entity("hhnl.Formicae.Application.Workflows.WorkflowParallelExecution", b =>
                {
                    ...
                    b.Property<string>("EntryPlanArtifact")
                        .HasColumnType("text");
                    ...
                    b.ToTable("workflow_parallel_executions", (string)null);
                });
            ...
            modelBuilder.Entity("hhnl.Formicae.Application.Workflows.WorkflowTriggerEvent", b =>
                {
                    ...
                    b.HasIndex("ExternalDeliveryId", "TriggerId")
                        .IsUnique();
            ...
            modelBuilder.Entity("hhnl.Formicae.Application.Workflows.WorkflowTriggerEvent", b =>
                {
                    ...
                    b.HasOne("hhnl.Formicae.Application.Workflows.WorkflowDefinitionVersion", null)
                        .WithMany()

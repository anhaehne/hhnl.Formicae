...
description: Use when the user wants to shape a feature spec and implementation plan using Agent OS project docs and standards.
---
...
Ask the user directly to understand the scope:
...
If it exists, read key files (like `mission.md`, `roadmap.md`, `tech-stack.md`) and use direct user question:

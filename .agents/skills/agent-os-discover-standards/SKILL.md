...
description: Use when the user wants to discover and document concise Agent OS standards from patterns in this repository.
---
...
3. Ask the user directly to present the areas:
...
3. Ask the user directly to present findings and let user select:
...
1. **Ask 1-2 clarifying questions** about the "why" behind the pattern. Ask the user directly and wait for their answer.
...
3. Draft the content and Ask the user directly to confirm:
...
2. For each new file without an index entry, use direct user question:
